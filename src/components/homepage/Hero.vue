                ...
                <main class="mx-auto mt-10 max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 xl:mt-36">
                    <div class="sm:text-center lg:text-left">
                        <h1
                            ...
                            <span class="block mb-2 lg:mb-4">Design Better &</span>
                            <span class="block">Faster Than Before.</span>
                        </h1>
                        <p
                            class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-4 md:text-xl lg:mx-0">
                            Accelerate your work with our millions
                            <span class="block lg:mb-2"></span> of ready-to-use design projects.
                        </p>
                        <div class="mt-5 sm:mt-9 sm:flex sm:justify-center lg:justify-start">
